...
-- Note: status and environment columns already exist in tenants table from 000_create_tenants_table.sql

-- Create users table (final state with nullable tenant_id and correct roles)
CREATE TABLE users (
    ...
    tenant_id UUID REFERENCES tenants(id) ON DELETE CASCADE, -- Nullable for system_admin users
...
('00000000-0000-0000-0000-000000000001', 'admin@docextract.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/9.8.8.8', 'Admin', 'User', 'system_admin', 'active', '00000000-0000-0000-0000-000000000001');
